...
import findRoute, {
  getUrlQuery,
} from '/Users/long/project/ant/node_modules/_umi-build-dev@1.13.12@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('../../../node_modules/_umi-plugin-ui@1.2.12@umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: '/Users/long/project/ant',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../node_modules/_umi-build-dev@1.13.12@umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
