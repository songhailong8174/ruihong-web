...
import findRoute, {
  getUrlQuery
} from "/Users/long/project/front/ruihong/ruihong-web/node_modules/_umi-build-dev@1.18.5@umi-build-dev/lib/findRoute.js";
...
(() => {
  try {
    ...
    require("../../../node_modules/_umi-plugin-ui@1.5.3@umi-plugin-ui/lib/bubble").default(
      {
        port: 3000,
        path: "/Users/long/project/front/ruihong/ruihong-web",
        currentProject: "",
        isBigfish: undefined
      }
    );
