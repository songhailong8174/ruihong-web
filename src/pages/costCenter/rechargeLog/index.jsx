...
@connect(({ rechageLog, loading }) => ({
  rechageLog,
  loading: loading.models.rule,
}))
class rechageLogList extends Component {
  state = {
    modalVisible: false,
  ...
  columns = [
    ...
    {
      title: '充值描述',
      dataIndex: 'rechargDesc',
    },
    {
      title: '充值短信内容',
      dataIndex: 'rechargSms',
    },
    {
      title: '操作时间',
...
export default Form.create()(rechageLogList);
