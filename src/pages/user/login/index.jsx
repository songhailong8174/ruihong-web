...
class Login extends Component {
  ...
  handleSubmit = (err, values) => {
    ...
    if (!err) {
      ...
      if (type === 'mobile') {
        this.handleRegister(values, type, dispatch);
        return;
      }
      dispatch({
  ...
  handleRegister = (values, type, dispatch) => {
    dispatch({
          ...
          >
            ...
            <UserName
              ...
              rules={[
                ...
                {
                  validator: (rule, value, callback) => this.handleUserCheckValidator(rule, value, callback)
                }
              ]}
            />  
            <Mobile
            ...
            <Submit loading={submitting} style={{float: 'left'}} disabled={ !this.state.agree }>
                注册
            </Submit>
          </Tab>
