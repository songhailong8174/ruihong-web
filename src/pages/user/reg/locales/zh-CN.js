export default {
  "user-retrieve.tab": "找回密码",
  "user-retrieve.login": "使用已有账户登录",
  "user-retrieve.submitName": "更新密码",
  ...
  "user-login.login.agree": "我已阅读并同意",
  "user-login.login.forgot-password": "找回密码",
  ...
  "user-login.userName.required": "请输入手机号!",
